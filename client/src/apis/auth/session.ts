...
export async function isLogin() {
  try {
    const apiUrl = `http://127.0.0.1:8000/api/session/is_login`
...
export async function signIn(email: string, password: string) {
  try {
    const apiUrl = `http://127.0.0.1:8000/api/session/sign_in`
...
export async function signOut() {
  try {
    const apiUrl = `http://127.0.0.1:8000/api/session/sign_out`
