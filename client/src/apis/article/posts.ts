...
export async function getPublishedArticle(page: number) {
  try {
    const apiUrl = `https://rapid-tsukumi-6067.lolipop.io/api/article/get_published_article?page=${page}`
...
export async function getArticle(slug: any) {
  try {
    const apiUrl = `https://rapid-tsukumi-6067.lolipop.io/api/article/get_article/${slug}`
...
export async function getAllArticle(page: number) {
  const apiUrl = `https://rapid-tsukumi-6067.lolipop.io/api/article/get_all_article?page=${page}`
...
export async function removeArticle(articleId: number) {
  const apiUrl = `https://rapid-tsukumi-6067.lolipop.io/api/article/remove_article/${articleId}`
...
export async function submitArticle(adminId: string, title: string, content: string, featuredImage: File, metaDescription: string, publicStatus: boolean) {
  try {
    const apiUrl = `https://rapid-tsukumi-6067.lolipop.io/api/article/submit_article`;
...
export async function getEditingArticle(articleId: any) {
  const apiUrl = `https://rapid-tsukumi-6067.lolipop.io/api/article/get_editing_article/${articleId}`
...
export async function updateArticle(articleId: any, adminId: string, title: string, content: string, featuredImage: File, metaDescription: string, publicStatus: boolean) {
  try {
    const apiUrl = `https://rapid-tsukumi-6067.lolipop.io/api/article/article_editing/${articleId}`;
