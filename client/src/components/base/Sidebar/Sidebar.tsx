  ...
  return (
    <div className='side-container'>
        ...
        <div>
          ...
          <span>
            <a href="https://github.com/Hayate12345" target="_blank">
              ...
              <div className="tooltip">Hayate12345</div>
            </a>
            ...
            <a href="https://twitter.com/EUREKA_221" target="_blank">
              ...
              <div className="tooltip">HaYat3X</div>
            </a>
          </span>
        </div>
      </div>
      ...
      <p>
        ...
        時代に合わせた技術を追いかけつつ、クライアントに寄り添い、クライアントの悩みや課題を解決できる。 そんなエンジニアになりたいと考えています。
      </p>
