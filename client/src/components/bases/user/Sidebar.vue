  ...
  <div class="sidebar-container">
    <div class="profile-area">
      <q-item>
        ...
        <q-item-section>
          <q-item-label class="name">Hayate Takeda</q-item-label>
          <q-item-label caption>
            <a href="https://github.com/Hayate12345" target="_blank">
              ...
              <q-tooltip>GitHub: Hayate12345</q-tooltip>
            </a>

            <a href="https://twitter.com/EUREKA_221" target="_blank" style="margin-left: 5px">
              ...
              <q-tooltip>X: ＠EUREKA_221</q-tooltip>
            </a>
          </q-item-label>
        </q-item-section>
      </q-item>
